...
-- 合同管理权限
('CONTRACT_VIEW', '查看合同', 'API', '/api/contracts/**', 50, NOW()),
('CONTRACT_CREATE', '创建合同', 'API', '/api/contracts', 51, NOW()),
('CONTRACT_SIGN', '签署合同', 'API', '/api/contracts/*/sign', 52, NOW()),
('CONTRACT_TEMPLATE_MANAGE', '管理合同模板', 'API', '/api/contract-templates/**', 53, NOW()),

-- 财务管理权限
('FINANCE_VIEW', '查看财务', 'API', '/api/finance/**', 60, NOW()),
('FINANCE_RECORD_MANAGE', '管理财务记录', 'API', '/api/finance/records/**', 61, NOW()),
('FINANCE_REPORT_VIEW', '查看财务报表', 'API', '/api/finance/reports/**', 62, NOW()),
('FINANCE_REPORT_GENERATE', '生成财务报表', 'API', '/api/finance/reports/generate', 63, NOW()),

-- 权限管理权限
('PERMISSION_VIEW', '查看权限', 'API', '/api/permissions/**', 70, NOW()),
('PERMISSION_MANAGE', '管理权限', 'API', '/api/permissions/**', 71, NOW()),
('ROLE_VIEW', '查看角色', 'API', '/api/roles/**', 72, NOW()),
('ROLE_MANAGE', '管理角色', 'API', '/api/roles/**', 73, NOW()),

-- 通知管理权限
('NOTIFICATION_VIEW', '查看通知', 'API', '/api/notifications/**', 80, NOW()),
